...
public class BigDecimalUtil {
	...
	public static void main(String args[]){
		double d = 1.9;
		double e = 0.3;
		//System.out.println(BigDecimalUtil.div(BigDecimalUtil.mul(BigDecimalUtil.mul(3750, 14),2.2),36000));
		//System.out.println(d+e);
		//System.out.println(BigDecimalUtil.decimalDown(100.0, 2));
		System.out.println(calInterest(10.00,360,100));
		System.out.println(BigDecimalUtil.mul(BigDecimalUtil.mul(10.00,360),100));
	}
