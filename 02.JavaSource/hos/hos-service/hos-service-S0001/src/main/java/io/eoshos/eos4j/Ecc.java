...
import io.eoshos.eos4j.ecc.EccTool;
...
public class Ecc {
	...
	public static String parseTransferlockData(String from, String to, String quantity,String lockQuantity,String lockTime, String memo) {
		return Ese.parseTransferlockData(from, to, quantity,lockQuantity,lockTime, memo);
	}
	 ...
	 * @return
	 */
	public static String parseLockData(String contractAccount, String user) {
		return Ese.parseLockData(contractAccount, user);
	}
	 ...
	 * @return
	 */
	public static String parseUnLockData(String contractAccount, String user) {
		return Ese.parseUnLockData(contractAccount, user);
	}
}
