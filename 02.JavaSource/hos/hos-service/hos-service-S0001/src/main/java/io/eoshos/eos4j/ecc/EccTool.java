package io.eoshos.eos4j.ecc;

import java.io.UnsupportedEncodingException;
import java.math.BigInteger;

import io.eoshos.eos4j.api.vo.transaction.push.TxSign;
import io.eoshos.eos4j.utils.Base58;
import io.eoshos.eos4j.utils.ByteBuffer;
import io.eoshos.eos4j.utils.ByteUtils;
import io.eoshos.eos4j.utils.EException;
import io.eoshos.eos4j.utils.Hex;
import io.eoshos.eos4j.utils.ObjectUtils;
import io.eoshos.eos4j.utils.Ripemd160;
import io.eoshos.eos4j.utils.Sha;
...
public class EccTool {
	...
	public static String signHash(String pk, byte[] b) {
		...
		try {
			...
			System.out.println("data=["+new String(b,"utf-8")+"]");
