...
public class HosUserInviteDto extends BaseBeanDto{
	...
	@ApiModelProperty(value="邀请人ID", name="userId", example="", required=true, hidden=false)
    private Long userId;
	
	@ApiModelProperty(value="被邀请人ID", name="userId", example="", required=false, hidden=false)
