...
@ApiModel
public class HosTradeList extends BaseBeanPo{
	
	private static final long serialVersionUID = -1078911800948283901L;
	...
	public String toString() {
		return "HosTradeList [userId=" + userId + ", userAccountId=" + userAccountId + ", txHash=" + txHash
				+ ", blockId=" + blockId + ", tradeTime=" + tradeTime + ", addrFrom=" + addrFrom + ", addrTo=" + addrTo
				+ ", coinNumber=" + coinNumber + ", tag=" + tag + ", notes=" + notes + "]";
	}
