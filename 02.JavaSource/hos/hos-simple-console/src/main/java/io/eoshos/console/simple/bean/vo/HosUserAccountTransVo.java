...
@ApiModel
public class HosUserAccountTransVo extends BaseBeanVo{
	...
	@ApiModelProperty(value="附件全称", name="fullFileName", example="", required=true, hidden=false)
    private String fullFileName;	
	
	@ApiModelProperty(value="附件缩略", name="thumbnailFileName", example="", required=true, hidden=false)
