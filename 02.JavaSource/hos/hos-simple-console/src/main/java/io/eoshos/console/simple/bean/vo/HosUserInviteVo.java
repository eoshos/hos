...
@ApiModel
public class HosUserInviteVo extends BaseBeanVo{
	...
	@ApiModelProperty(value="被邀请人实名认证", name="inviteUserRealStat", example="", required=false, hidden=false)
    private String inviteUserRealStat;	
	...
	public String getInviteUserRealStat() {
		return inviteUserRealStat;
	}

	public void setInviteUserRealStat(String inviteUserRealStat) {
		this.inviteUserRealStat = inviteUserRealStat;
	}
