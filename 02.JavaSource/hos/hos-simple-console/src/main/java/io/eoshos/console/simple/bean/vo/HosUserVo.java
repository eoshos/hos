...
public class HosUserVo extends BaseBeanVo{
	...
	@ApiModelProperty(value="认证时间", name="authTimeStr", example="", required=false, hidden=false)
	...
	@ApiModelProperty(value="邀请人数", name="inviteTotal", example="", required=false, hidden=false)
    private Integer inviteTotal;
	

	@Override
	public String toString() {
		return "HosUser [userType=" + userType + ", phone=" + phone + ", userName=" + userName
				+ ", cardId=" + cardId + ", realName=" + realName + ", picPath1=" + picPath1
				+ ", picPath2=" + picPath2 + ", picPath3=" + picPath3 + ", realStat=" + realStat + ", authTime="
				+ authTime + ", eosWallet=" + eosWallet + ", inviteUserId=" + inviteUserId + ", inviteCode="
				+ inviteCode + ", stat=" + stat + ", operIp=" + operIp + "]";
	}
